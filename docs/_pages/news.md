...
<img src="{{ '/assets/features/db_download.png' | relative_url }}" alt="SIRIUS feature: Library downloader" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/db_export.png' | relative_url }}" alt="SIRIUS feature: db exporter" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/substructure_export.png' | relative_url }}" alt="SIRIUS feature: substructure annotation export" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/jump.png' | relative_url }}" alt="SIRIUS feature: direct navigation" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/sketcher-duplicates.png' | relative_url }}" alt="SIRIUS feature: Sketcher duplicate check" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/toolchain.png' | relative_url }}" alt="SIRIUS feature: avoid re-computation" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/import_filter.png' | relative_url }}" alt="SIRIUS feature: High-res filter" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/summary_export.png' | relative_url }}" alt="SIRIUS feature: improved result export" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/sketcher.png' | relative_url }}" alt="SIRIUS feature: Structure Sketcher" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/lcms-align.png' | relative_url }}" alt="SIRIUS feature: LC-MS pre-alignment" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/mouseover.png' | relative_url }}" alt="SIRIUS feature: mouseover preview" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/substructure_annotation.png' | relative_url }}" alt="SIRIUS feature: Substructure annotations for analog matches" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/KMD.png' | relative_url }}" alt="SIRIUS feature: Kendrick Mass Defect plots for homologous series" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/software-tour.png' | relative_url }}" alt="SIRIUS feature: Software Tour" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/global-db.png' | relative_url }}" alt="SIRIUS feature: Global database selection" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/lcms-view.png' | relative_url }}" alt="SIRIUS feature: Improved result views" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/compute-presets.png' | relative_url }}" alt="SIRIUS feature: Compute presets" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/fast_spectral_search.png' | relative_url }}" alt="SIRIUS feature: Fast Spectral Search" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/coloring.png' | relative_url }}" alt="SIRIUS feature: New Coloring Scheme" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
**New Color Scheme:**
...
<img src="{{ '/assets/features/toolchain.png' | relative_url }}" alt="SIRIUS feature: Streamlined Workflows" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/lcms-view.png' | relative_url }}" alt="SIRIUS feature: LC-MS/MS preprocessing" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/welcome_page.png' | relative_url }}" alt="SIRIUS feature: Welcome-Page Redesign" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/result_views.png' | relative_url }}" alt="SIRIUS feature: Result Views" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
[**Improved Result Views:**]({{ "gui/#visualize-results" | relative_url }})
...
<img src="{{ '/assets/features/export_results.png' | relative_url }}" alt="SIRIUS feature: Export Results" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/expansive_search.png' | relative_url }}" alt="SIRIUS feature: Expansive Search" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/bottom_up.png' | relative_url }}" alt="SIRIUS feature: Bottom-up search" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/coloring.png' | relative_url }}" alt="SIRIUS feature: New Molecular Fingerprint" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/spectral_search.png' | relative_url }}" alt="SIRIUS feature: Spectral Search" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/approx-confidence.png' | relative_url }}" alt="SIRIUS feature: Approximate Confidence Score" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/API.png' | relative_url }}" alt="SIRIUS feature: API" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
...
<img src="{{ '/assets/features/dark-mode.png' | relative_url }}" alt="SIRIUS feature: Dark Mode" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">
**SIRIUS dark mode:**
...
<img src="{{ '/assets/features/nitrite_database.png' | relative_url }}" alt="SIRIUS feature: Nitrite Database" style="float: left; margin-right: 20px; width: 200px; max-width: 30%;">

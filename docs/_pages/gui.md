...
- If SIRIUS [predicts that the query spectrum may be a lipid]({{"/methods-background/#lipid-detection" | relative_url}}), the molecular formula
  according to that prediction is enforced (default) <span style="color:#d40f57">**[5]**</span>.
  If the molecular formula is not in the selected database, it will not be enforced, but will be added as candidate. 
...
- **white on dark blue:** This is a lipid database <span style="color:#d40f57">**[b]**</span> or lipid class annotation (_El Gordo_) (see below) <span style="color:#d40f57">**[d]**</span>.
...
This view also includes the [lipid class annotation (_El Gordo_)]({{"/methods-background/#lipid-detection" | relative_url}}) <span style="color:#d40f57">**[d]**</span>.
If the feature has been identified as lipid a blue notification displaying the classification will appear below the top ribbon.
